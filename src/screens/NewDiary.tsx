			...
			<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
				<KeyboardAwareScrollView> 
					<KeyboardAvoidingView>
						<TextInput style={styles.inputTitle} onChangeText={setNewTitle} placeholder="제목" maxLength={30} />
						<View style={styles.content}>
						<TextInput style={styles.inputContent} onChangeText={setNewContent} placeholder="내용을 입력하세요" maxLength={1500} multiline={true}/>
						</View>
					</KeyboardAvoidingView>
				</KeyboardAwareScrollView>
